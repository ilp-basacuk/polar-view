...
const SidebarEditView: FC = () => {
  ...
  return (
    <div
      className="space-y-1 overflow-hidden overflow-y-auto"
                    ...
                    <div className="p-10 space-y-10 overflow-auto md:flex md:space-x-10 md:space-y-0">
                      <div className="w-full">
                        ...
                        <div className="space-y-5 text-mainblue">
                          <p>
                            Satellite SAR is a form of imagery where pulses of radar are used to
                            create images of the Earth surface. The images are unaffected by clouds
                            and work equally well during day and night. Imaging radar is similar to
                            a photograph taken by a camera, but the image is of radar waves, not
                            visible light.
                          </p>
                          <p>
                            Sea ice typically reflects more of the radar energy emitted by the
                            sensor than the surrounding ocean, which makes it easy to distinguish
                            between the two. But the amount and character of reflected energy are
                            functions of the physical properties of the sea ice, which can be quite
                            complex; thus, it can be difficult to interpret radar images of sea ice.
                            In the past the Antarctic was extensively imaged using the ENVISAT ASAR
                            instrument. More recently we have provided access to Radarsat2 and
                            Cosmo-Skymed SAR imagery. In the very near future we will provide rapid
                            access to imagery from the new European Sentinel-1 satellite.
                          </p>
                        </div>
                      </div>
