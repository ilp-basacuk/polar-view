(window.webpackJsonp = window.webpackJsonp || []).push([
  [0],
  {
    470(module, __webpack_exports__, __webpack_require__) {
      ...
      const objectWithoutPropertiesLoose = __webpack_require__(51);
      const esm_extends = __webpack_require__(7);
      const inheritsLoose = __webpack_require__(134);
      const react_dom = __webpack_require__(165);
      ...
      const enums = __webpack_require__(468);
      ...
      const DEFAULT_OPTIONS = { placement: 'bottom', modifiers: [], strategy: 'absolute' };
      ...
      const react_fast_compare = __webpack_require__(419);
        ...
        const _usePopper = (function usePopper(referenceElement, popperElement, options) {
          ...
          const updateStateModifier = react.useMemo(
            () => ({
              ...
              fn: function fn(_ref) {
                const { state } = _ref;
                let elements = Object.keys(state.elements);
                setState({
                  styles: fromEntries(
      ...
      const warning = __webpack_require__(894);
          ...
          return (
            ...
            (_this.showTooltip = function (_ref) {
              ...
              _this.props.followCursor &&
                (state = Object(esm_extends.a)({}, state, { pageX, pageY })),
      ...
      const utils = __webpack_require__(101);
      function _extends() {
        return (
          (_extends =
            Object.assign ||
      ...
      const Wrapper = esm.styled.div(
        (_ref3) => ({ display: _ref3.hidden ? 'none' : 'inline-block', zIndex: 2147483647 }),
        (_ref4) => {
          const { theme } = _ref4;
          const { color } = _ref4;
      ...
      var WithTooltip_WithTooltipPure = function WithTooltipPure(_ref) {
        ...
        return react_default.a.createElement(
          ...
          (_ref3) => {
            ...
            return react_default.a.createElement(
              Container,
              { ref: triggerRef, ...getTriggerProps(), ...props },
              children
            );
          }
        );
