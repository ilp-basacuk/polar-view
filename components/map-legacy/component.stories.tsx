...
// Controls
import Controls from 'components/map-legacy/controls';
import FitBoundsControl from 'components/map-legacy/controls/fit-bounds';
import ZoomControl from 'components/map-legacy/controls/zoom';
